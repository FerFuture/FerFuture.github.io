...
async function displayProductos() {
  try {
    ...
    const response = await fetch('https://marketweb.onrender.com/api/destacados');
...
function cerrarCarrito() {
  ...
  async function completarCompra() {
    try {
      ...
      const response = await fetch("https://marketweb.onrender.com/api/pay", {
        method: "post",
...
window.onload = async () => {
  mostrarLoader();
  productsList = await (await fetch("https://marketweb.onrender.com/api/productos")).json();
  displayProductos();
  ocultarLoader();
};
...
async function filtrarProductosPorCategoria(categoryId) {
  ...
  try {
    ...
    const response = await fetch(`https://marketweb.onrender.com/api/productos/categoria/${categoryId}`);
...
function cargarProductosPorCategoria(categoriaId) {
  ...
  fetch(`https://marketweb.onrender.com/api/productos/categoria/${encodeURIComponent(categoriaId)}`)
...
function cargarProductosPorSubcategoria(subcategoriaId) {
    fetch(`https://marketweb.onrender.com/api/productos/subcategoria/${encodeURIComponent(subcategoriaId)}`)
        .then(response => response.json())
        .then(productos => {
            const titulo = document.getElementById('titulo-categoria');
...
function cargarProductosPorNombre(nombre) {
  fetch(`https://marketweb.onrender.com/api/productos/buscar?termino=${encodeURIComponent(nombre)}`)
    .then(response => response.json())
    .then(productos => {
      const titulo = document.getElementById('titulo-categoria');
...
function cargarProductosOfertas() {
  ...
  fetch('https://marketweb.onrender.com/api/productos/ofertas')
    .then(response => response.json())
    .then(productos => {
      const titulo = document.getElementById('titulo-categoria');
